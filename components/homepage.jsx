...
export function Homepage() {
  ...
  return (
    (<div className="min-h-screen bg-gray-900 text-white overflow-hidden font-sans">
      <nav
        className="absolute top-0 left-0 right-0 z-10 flex justify-between items-center p-6 bg-transparent">
        <div
      ...
      <main
        ...
        <motion.div
          ...
          animate={{
            x: mousePosition.x - window.innerWidth / 5,
            y: mousePosition.y - window.innerHeight / 5,
          }}
        ...
        <motion.p
          ...
          Transform your data effortlessly with our intuitive and powerful formatting tool. 
        ...
        <motion.div
          ...
          <Button
            className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-10 py-4 rounded-full text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl">
            Get Started
          </Button>
        </motion.div>
      </main>
